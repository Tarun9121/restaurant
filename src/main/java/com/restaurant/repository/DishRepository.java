...
public interface DishRepository extends JpaRepository<Dish, UUID> {
    ...
    @Query(nativeQuery = true, value = "select * from food_items where is_veg = :isVeg and name like %:foodName%")
    List<Dish> getAllDishes(@Param("foodName") String foodName, @Param("isVeg") boolean isVeg);

    @Query(nativeQuery = true, value="select * from food_items where food_category = :foodCategory and name like %:foodName%")
    List<Dish> getAllDishes(@Param("foodCategory") String foodCategory, @Param("foodName") String foodName);

    @Query(nativeQuery = true, value = "select * from food_items where is_veg = :isVeg and food_category = :foodCategory and name like %:foodName%")
    ...
    @Query(nativeQuery = true, value="select * from food_items where food_category = :foodCategory and name like %:foodName% order by price asc")
    List<Dish> getAllDishesByAsc(@Param("foodCategory") String foodCategory, @Param("foodName") String foodName);

    @Query(nativeQuery = true, value = "select * from food_items where is_veg = :isVeg and name like %:foodName% order by price asc")
    List<Dish> getAllDishesByAsc(@Param("foodName") String foodName, @Param("isVeg") boolean isVeg);

    @Query(nativeQuery = true, value = "select * from food_items where is_veg = :isVeg and food_category = :foodCategory and name like %:foodName% order by price asc")
    ...
    @Query(nativeQuery = true, value = "SELECT * FROM food_items WHERE name like %:foodName% ORDER BY price DESC")
    List<Dish> getAllDishesByNameAndIsVegDesc(@Param("foodName") String foodName);

    @Query(nativeQuery = true, value = "SELECT * FROM food_items WHERE name like %:foodName% ORDER BY price ASC")
    List<Dish> getAllDishesByNameAndIsVegAsc(@Param("foodName") String foodName);

    @Query(nativeQuery = true, value = "SELECT * FROM food_items WHERE food_category = :foodCategory AND is_veg = :isVeg ORDER BY price DESC")
    List<Dish> findByFoodCategoryAndIsVegDesc(@Param("foodCategory") String foodCategory, @Param("isVeg") boolean isVeg);

    @Query(nativeQuery = true, value = "SELECT * FROM food_items WHERE food_category = :foodCategory AND is_veg = :isVeg ORDER BY price ASC")
